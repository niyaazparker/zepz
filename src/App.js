        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-7">
                    <h1 className="mb-0">Stack Overflow Users</h1>
                </div>
          ...
          {currentUsers.map((user) => (
            ...
            <div className="card p-4" key={user.user_id}>
              ...
              <div className={`mt-2 border-top pt-3 mt-3 ${expandedUser === user.user_id ? 'expand-content ' : 'collapse-content'}`}>
                <p className='mb-1'><strong>Reputation:</strong> {user.reputation}</p>
                <p className='mb-1'><strong>Location:</strong> {user.location}</p>
                <p className='mb-0'><strong>Website:</strong> {user.website_url}</p>
              </div>
            )}
            </div>
